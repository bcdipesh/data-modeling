...
CREATE TABLE posts_categories (post_id INTEGER REFERENCES posts(id),
...
VALUES ('Electronics'), ('Housing'), ('Services');
...
SELECT title AS post_title, text, username,
                                  location,
                                  name
FROM posts
